...
{
    public FakeAppClient(IHttpClientFactory httpClientFactory, XtiTokenAccessor xtiTokenAccessor, AppClientUrl clientUrl, IAppClientRequestKey requestKey, FakeAppClientVersion version) : base(httpClientFactory, xtiTokenAccessor, clientUrl, requestKey, "Fake", version.Value)
    {
