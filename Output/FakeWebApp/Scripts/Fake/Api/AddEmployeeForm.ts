...
export class AddEmployeeForm extends BaseForm {
	...
	constructor(view: AddEmployeeFormView) {
		...
		this.HireDate.setItems(
			new DropDownFieldItem(new Date(Date.UTC(2022, 8, 21, 4, 0, 0, 0)), 'Yesterday'),
			new DropDownFieldItem(new Date(Date.UTC(2022, 8, 22, 4, 0, 0, 0)), 'Today'),
			new DropDownFieldItem(new Date(Date.UTC(2022, 8, 23, 4, 0, 0, 0)), 'Tomorrow')
		);
