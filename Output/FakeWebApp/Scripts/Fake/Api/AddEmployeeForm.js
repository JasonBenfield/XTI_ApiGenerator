...
var AddEmployeeForm = /** @class */ (function (_super) {
    ...
    function AddEmployeeForm(vm) {
        ...
        _this.HireDate.setItems(new DropDownFieldItem_1.DropDownFieldItem(new Date(Date.UTC(2021, 0, 18, 5, 0, 0, 0)), 'Yesterday'), new DropDownFieldItem_1.DropDownFieldItem(new Date(Date.UTC(2021, 0, 19, 5, 0, 0, 0)), 'Today'), new DropDownFieldItem_1.DropDownFieldItem(new Date(Date.UTC(2021, 0, 20, 5, 0, 0, 0)), 'Tomorrow'));
